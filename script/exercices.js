...
function exo2(){
    ...
    reset.addEventListener("click",function(){
        ...
        code.value = '<p class="text-xl">Ce texte a actuellement une taille extra-large. Modifiez la classe pour ajuster la taille du texte.</p>'
        display.innerHTML = '<p class="text-xl">Ce texte a actuellement une taille extra-large. Modifiez la classe pour ajuster la taille du texte.</p>'
    })

    let correctAnswer = '<p class="text-lg">Ce texte a actuellement une taille extra-large. Modifiez la classe pour ajuster la taille du texte.</p>'
